    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black p-4 font-[family-name:var(--font-geist-sans)]">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tight">Welcome Back</h1>
          <p className="text-gray-500 dark:text-zinc-500 text-sm mt-2 font-medium">Access your intelligent spreadsheet dashboard</p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-950 border border-gray-100 dark:border-zinc-800 rounded-3xl shadow-2xl overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 dark:text-zinc-500 uppercase tracking-[0.2em] ml-1 flex items-center gap-1">
                Admin Key 
                <span className="text-[8px] font-bold text-gray-300 dark:text-zinc-600 italic">(optional)</span>
              </label>
              <div className="relative">
                <input
                  name="adminKey"
          ...
          <div className="px-8 py-6 bg-gray-50 dark:bg-zinc-900/50 border-t border-gray-100 dark:border-zinc-800 text-center">
            <p className="text-xs font-bold text-gray-500 dark:text-zinc-500 uppercase tracking-tight">
              ...
              <Link href="/signup" className="text-blue-600 dark:text-blue-400 ml-2 hover:underline">Create Account</Link>
            </p>
          </div>
        </div>
      </div>
